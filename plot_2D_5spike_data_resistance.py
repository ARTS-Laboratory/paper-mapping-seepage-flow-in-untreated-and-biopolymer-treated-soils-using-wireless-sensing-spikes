...
s1=calculate_resistance(D1.iloc[:,1])/1000 # spike 1
s2=calculate_resistance(D1.iloc[:,2])/1000 #spike 2
s3=calculate_resistance(D1.iloc[:,3])/1000 # spike 3
s4=calculate_resistance(D1.iloc[:,4])/1000 # spike 4
...
s3=calculate_resistance(D1.iloc[:,3])/1000 # spike 3
s4=calculate_resistance(D1.iloc[:,4])/1000 # spike 4
s5=calculate_resistance(D1.iloc[:,5])/1000 # spike 5
